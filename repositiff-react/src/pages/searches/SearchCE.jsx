...
const SearchCE = () => {
    ...
    const fetchAllWorks = async () => {
        ...
        try {
            ...
            console.log("DADOS VINDOS DA API:", data.result);
            // 👇 ADICIONE O FILTRO AQUI
            const computerEngineeringWorks = (data.result || []).filter(
                (work) => work.course.name === "Engenharia de Computação"
            );
            
            // 👇 AQUI você define o estado APENAS com os trabalhos filtrados

...
const SearchPage = () => {
  ...
  useEffect(() => {
    const fetchAllWorks = async () => {
      ...
      try {
        ...
        // REMOVIDO: O filtro de trabalhos públicos foi retirado daqui.
        console.log('Trabalhos carregados:', worksData);
        setAllWorks(worksData);
        
        toast.success(`${worksData.length} trabalhos carregados com sucesso.`);
      } catch (error) {
  ...
  return (
    <div className="container mx-auto p-4 md:p-8">
      ...
      {/* Barra de busca principal no topo */}
          ...
          {isLoading ? (
            ...
            <div className="space-y-6">
              {filteredResults.length > 0 ? (
                ...
                <div className="text-center py-10 bg-gray-50 rounded-lg"><p>Nenhum resultado encontrado.</p></div>
              )}
            </div>
          )}
        </main>

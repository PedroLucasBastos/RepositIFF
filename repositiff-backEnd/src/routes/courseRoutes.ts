...
export async function courseRoutes(fastify: FastifyInstance) {
    ...
    fastify.post('/register', async (req: FastifyRequest<{ Body: ICourseProps }>, reply: FastifyReply) => {
    ...
    fastify.put('/update', async (req: FastifyRequest<{ Body: ICourseUpdateProps }>, reply: FastifyReply) => {
        console.log(req.body)
        try {
    ...
    fastify.delete('/delete', async (req: FastifyRequest<{ Body: IDeleteProps }>, reply: FastifyReply) => {
        console.log(req.body)
        try {

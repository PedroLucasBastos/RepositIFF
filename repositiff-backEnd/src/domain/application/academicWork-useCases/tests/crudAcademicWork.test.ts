...
} from "@src/domain/application/academicWork-useCases/createAcademicWork-useCase.js";
...
import { BasicUpdateAcademicWorkUseCase } from "../UpdateAcademicWorkBasicInfoUse_case.js";
...
describe("asdfsadfasdf", async () => {
  ...
  it("asdfasdfsadfasdfasdfsdf", async () => {
    ...
    const info: CreateProjectUseCaseDTO = {
      authors: ["Michael Johnson-useCase1", "Beltrano-useCase1"],
      idAdvisors: [advisor.id],
      ...
      qtdPag: 150,
      description:
        "Este trabalho aborda a análise de grandes volumes de dados em corporações multinacionais, utilizando técnicas avançadas de estatística e aprendizado de máquina.",
    ...
    const sup = new BasicUpdateAcademicWorkUseCase(repo);
